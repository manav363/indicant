...
class TestMarketAggregatorUnit:
    ...
    def test_aggregate_signal_risk_on_majority(self):
        ...
        from market_regime.regime.market import RegimeAggregator
    ...
    def test_default_tickers_has_50(self):
        """Default NIFTY 50 fallback should have 50 tickers."""
        from market_regime.regime.market import RegimeAggregator

        tickers = RegimeAggregator._default_tickers()
        assert len(tickers) == 50

    def test_reporting_ratio(self):
        """MarketRegimeResult.reporting_ratio reflects data quality."""
        from market_regime.regime.market import MarketRegimeResult
...
class TestMarketAggregatorCache:
    ...
    def test_second_call_within_ttl_uses_cache(self, monkeypatch):
        ...
        agg = RegimeAggregator(tickers=["RELIANCE.NS", "TCS.NS"])
